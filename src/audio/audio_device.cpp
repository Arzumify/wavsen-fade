...
AudioDevice::~AudioDevice() { uninit(); }
...
bool AudioDevice::init() {
    ...
    static const ::pw_stream_events stream_events = {
        ...
        .destroy       = nullptr,
        .state_changed = &AudioDevice::on_state_changed,
        .control_info  = nullptr,
        .io_changed    = nullptr,
        .param_changed = nullptr,
        .add_buffer    = nullptr,
        .remove_buffer = nullptr,
        .process       = &AudioDevice::on_process,
        .drained       = nullptr,
        .command       = nullptr,
...
void AudioDevice::mount(std::unique_ptr<IPullChannel> ch) {
    if (is_inited()) {
        ch->pass_desc(desc_);
    }
    std::lock_guard<std::mutex> lk(channels_mu_);
...
void AudioDevice::on_process(void* user) {
...
void AudioDevice::on_state_changed(void* /*user*/, ::pw_stream_state /*old*/,
